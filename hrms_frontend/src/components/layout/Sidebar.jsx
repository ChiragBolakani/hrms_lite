...
const Sidebar = () => {
  ...
  return (
    <aside className="hidden md:flex md:flex-col w-64 bg-sidebar min-h-screen">
      {/* Brand */}
      <div className="px-6 py-5 flex items-center gap-3">
        ...
        <span className="text-lg font-bold text-white tracking-tight">HRMS Lite</span>
      </div>
      ...
      <div className="px-4 py-4 border-t border-indigo-800">
        <p className="text-xs text-indigo-400 text-center">HRMS Lite v1.0</p>
      </div>
    </aside>
  );
};
